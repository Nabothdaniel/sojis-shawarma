...
// Hardcode connection to PRODUCTION so there is NO ambiguity
$dsn = "mysql:host=bamzysms.com;dbname=tiheogwi_bamzy_sms;charset=utf8mb4";
...
try {
    ...
    // Add CHECK constraint safely ignoring if it exists
    try {
    ...
    echo "All critical fixes applied to production.\n";
